...
## 6. Distribution-path validation — v1.0.22 public release

Complete local and public v1.0.22 evidence is in
`RELEASE_RECORD_1.0.22.md`. Historical releases remain in their versioned
release records.
...
- [x] Upgrade through Anki's native `AddonManager.install()` mechanism to the
      release candidate on every supported version. v1.0.21-to-v1.0.22 passed
...
- [x] Repeat clean install and v1.0.21 → v1.0.22 upgrade tests using that
...
The v1.0.22 artifact, hashes, compatibility evidence, GitHub release, live
AnkiWeb boundaries, and numeric-code installation evidence are recorded in
`RELEASE_RECORD_1.0.22.md`. Earlier releases remain in their versioned records.
