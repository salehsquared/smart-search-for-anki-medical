...
## 6. Distribution-path validation — v1.0.21 public release

Complete local and public v1.0.21 evidence is in
`RELEASE_RECORD_1.0.21.md`. Historical releases remain in their versioned
release records.
...
- [x] Upgrade through Anki's native `AddonManager.install()` mechanism to the
      release candidate on every supported version. v1.0.20-to-v1.0.21 passed
...
- [x] Repeat clean install and v1.0.20 → v1.0.21 upgrade tests using that
...
- [x] Install once more from the public code and compare all 66 installed
...
The v1.0.21 artifact, hashes, compatibility evidence, GitHub release, live
AnkiWeb boundaries, and numeric-code installation evidence are recorded in
`RELEASE_RECORD_1.0.21.md`. Earlier releases remain in their versioned records.
