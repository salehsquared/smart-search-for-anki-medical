...
![Smart Search results](https://raw.githubusercontent.com/salehsquared/smart-search-for-anki-medical/v1.0.22/release/assets/screenshots/01-smart-search.png)
...
- Press **Space** or **Right Arrow** to reveal a selected card's answer and
  **Left Arrow** to return to the front—even after clicking in the preview.
- Use **Shift+Space** to select a result for bulk actions.
- Repeated Semantic searches are much faster during an active search session.
- Flag, suspension, and tag changes update rows without reloading the result
  list. Press **Enter** whenever you want the active filters reapplied.

The isolated Semantic model still unloads when Search closes or reviewing
begins.

![Inline card preview and editor](https://raw.githubusercontent.com/salehsquared/smart-search-for-anki-medical/v1.0.22/release/assets/screenshots/05-inline-editor.png)

## Compatibility

Version 1.0.22 supports **Anki Desktop 24.11 through 26.08**, including the
