...
![Smart Search results](https://raw.githubusercontent.com/salehsquared/smart-search-for-anki-medical/v1.0.21/release/assets/screenshots/01-smart-search.png)
...
Version 1.0.21 fixes the high memory use that could remain after Semantic
Search finished. Semantic processing now runs only when needed and its memory
is reclaimed afterward. Reviews continue without search-index maintenance,
and existing downloaded model files and indexes are reused after a one-time
local upgrade step.

![Inline card preview and editor](https://raw.githubusercontent.com/salehsquared/smart-search-for-anki-medical/v1.0.21/release/assets/screenshots/05-inline-editor.png)

## Compatibility

Version 1.0.21 supports **Anki Desktop 24.11 through 26.08**, including the
