...
![Smart Search results](https://raw.githubusercontent.com/salehsquared/smart-search-for-anki-medical/v1.0.20/release/assets/screenshots/01-smart-search.png)
...
Version 1.0.20 keeps review sessions isolated from search maintenance. Edits
are retained in a crash-safe local queue and applied in small background
batches after reviewing, while Semantic resources load only when requested.

![Inline card preview and editor](https://raw.githubusercontent.com/salehsquared/smart-search-for-anki-medical/v1.0.20/release/assets/screenshots/05-inline-editor.png)

## Compatibility

Version 1.0.20 supports **Anki Desktop 24.11 through 26.08**, including the
